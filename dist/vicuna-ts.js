...
exports.VICUNA = void 0;
var child_process_1 = require("child_process");
var fs = require("fs");
var os = require("os");
var axios_1 = require("axios");
var ProgressBar = require("progress");
var VICUNA = /** @class */ (function () {
    function VICUNA(options) {
        this.options = options;
        this.bot = null;
        var defaults = {
            model: "ggml-vicuna-7b-4bit-rev1",
            executablePath: "".concat(os.homedir(), "/.vicuna_ts/main.exe"),
            modelPath: "".concat(os.homedir(), "/.vicuna_ts/").concat(options.model, ".bin"),
            forceDownload: false,
            decoderConfig: {},
            modelOverride: false,
        ...
        */
        if (("ggml-vicuna-13b-4bit-rev1" !== options.model &&
            "ggml-vicuna-7b-4bit-rev1" !== options.model) || options.modelOverride) {
            throw new Error("Model ".concat(options.model, " is not supported. Current models supported are: \n                ggml-vicuna-13b-4bit-rev1\n                ggml-vicuna-7b-4bit-rev1\n\n                or if you think your model can run on this package set\n                modelOverride=true\n                \n                "));
        }
    }
    VICUNA.prototype.init = function (forceDownload) {
    ...
    VICUNA.prototype.open = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        spawnArgs = [this.executablePath, '-i', '--interactive-first', '-r', "### Human:", '-t', '8', '--temp', '0', '-c', '2048', '-n', '-1', '--ignore-eos', '--repeat_penalty', '1.2', '--instruct', '--model', this.modelPath];
    ...
    VICUNA.prototype.close = function () {
        if (this.bot !== null) {
            this.bot.kill();
            this.bot = null;
        }
    };
    VICUNA.prototype.downloadExecutable = function () {
        return __awaiter(this, void 0, void 0, function () {
            var upstream, platform;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (platform === 'win32') {
                            ...
                            throw new Error("Your platform is not supported: ".concat(platform, ". Current binaries supported are for Windows. ill add others later or u can set in options"));
                        }
                        return [4 /*yield*/, this.downloadFile(upstream, this.executablePath)];
                    case 1:
                        _a.sent();
    ...
    VICUNA.prototype.downloadModel = function () {
        return __awaiter(this, void 0, void 0, function () {
            var modelUrl;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    VICUNA.prototype.downloadFile = function (url, destination) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        dir = new URL("file://".concat(os.homedir(), "/.vicuna_ts/"));
    ...
    VICUNA.prototype.prompt = function (prompt) {
        var _this = this;
        if (this.bot === null) {
